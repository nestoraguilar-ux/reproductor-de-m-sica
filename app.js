...
const botonRepruducirPausar = document.querySelector('.controles button.boton-reproducir-pausar');
...
const canciones = [
    {
        titulo:'Que Se Repita',
        nombre:'Almighty',
        fuente:'music/Almighty - Que Se Repita.mp3'
    },
    {
        titulo:'BOKeTe',
        nombre:'Bab Bunny',
        fuente:'music/Bad Bunny - BOKeTE.mp3'
    },
    {
        titulo:'Niño',
        nombre:'Milo j',
        fuente:'music/Milo j - Niño.mp3'
    },
];
...
botonRepruducirPausar.addEventListener('click',reproducirPausar);
